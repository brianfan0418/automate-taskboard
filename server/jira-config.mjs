...
function parseConfig(value) {
  if (
    ...
    throw new JiraConfigError("INVALID_JIRA_CONFIG", "Jira 設定檔無效");
  }
  ...
  if (Object.keys(value).some((key) => !allowedKeys.has(key))) {
    throw new JiraConfigError("INVALID_JIRA_CONFIG", "Jira 設定檔包含未知欄位");
  }
  ...
  if (
    ...
    throw new JiraConfigError("INVALID_JIRA_CONFIG", "Jira 設定缺少穩定實例身分");
  }
